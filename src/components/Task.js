        ...
        <div className='bg-blue w-full p-0 flex justify-center font-sans'>
            <div class="rounded bg-grey-light w-64 p-2">
                ...
                <div class="text-sm mt-2">
                    ...
                    <p class="mt-3 text-grey-dark"><button className='bg-blue-100 px-2 py-1 text-xs font-semibold tracking-wider text-red-600 rounded
           hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2' onClick={() => onDelete(task.id)}>Delete</button></p>
                </div>
            </div>
        </div>
    )
